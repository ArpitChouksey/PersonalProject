...
resource "aws_apigatewayv2_integration" "alb" {
  ...
  for_each = local.alb_integrations
  ...
  lifecycle {
    ...
    precondition {
      ...
      error_message = "ALB integration requires config.listener_arn."
    ...
    precondition {
      ...
      error_message = "ALB integration requires a VPC Link ID."
